...
<html>
  <head>
    ...
    <title>Early Warning | Dashboard</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><small><i>Early Warning Ibun Waterfall</i></small></span>
        </a>
      ...
      <aside class="main-sidebar">
       ...
       <!--      </li>
            ...
            <li class="treeview">
              <a href="?page=vwUs">
                <i class="fa fa-files-o"></i> <span>Data User</span>
             ...
             <li class="treeview">
              <a href="?page=vwOp">
                <i class="fa fa-files-o"></i> <span>Data Banjir</span>
        <i class="fa fa-angle-left pull-right"></i>
              </a>
	...
	<!-- 		<li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="?page=adPm"><i class="fa fa-circle-o"></i> Peminjaman</a></li>
                <li><a href="?page=adPe"><i class="fa fa-circle-o"></i> Pengembalian</a></li>
			  </ul>
            </li> -->
			<!-- <?php } ?> -->
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2020 <a href="#">Belajar Website</a>.</strong> Asep.
      </footer>
