...
<html>
  <head>
    ...
    <title>Early Warning | Log in</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html">Early Warning<b><i>Ibun Waterfall</i></b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Login Untuk Menuju Halaman Administrator</p>
