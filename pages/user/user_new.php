				...
				<div class="col-md-12">
					<div class="box">
						<div class="box-header with-border">
							<h3 class="box-title">Tambah Data Pengguna <small>Daya Motor</small></h3>
							<!-- tools box -->
						...
						<form role="form" name="form1" action="?page=svUs" method="post" enctype="multipart/form-data" onSubmit="return validasi()">
							<div class="box-body">
								...
								<p>
									<div class="form-group">
										<label for="exampleInputKotaKab1">Username</label>
										<input type="text" class="form-control" name="username" id="exampleInputKotaKab1" placeholder="Masukkan Username" required="required">
									</div>
								</p>
					
								<p>
									<div class="form-group">
										<label for="exampleInputKodepos1">Password</label>
										<input type="Password" class="form-control" name="passwd" id="exampleInputKodepos1" placeholder="Masukkan Password" required="required">
									</div>
								</p>
