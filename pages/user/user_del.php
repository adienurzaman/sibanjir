<?php
	...
	$data=mysqli_fetch_array(mysqli_query($connect, "SELECT img_pengguna FROM pengguna WHERE email_pengguna = '$_GET[tid]'"));
  	if ($data['img_pengguna']!=''){
    	mysqli_query($connect, "DELETE FROM pengguna WHERE email_pengguna = '$_GET[tid]'");
